...
import { forgotPassword, resendResetLink, verifyResetToken, changePassword } from "@/store/actions/authAction";
  ...
  useEffect(() => {
    ...
    if (urlToken) {
      ...
      dispatch(verifyResetToken({ token: urlToken }))
        .unwrap()
        .then(() => {
          toast.success("Token verified. Please set a new password.", {id: "token-verified"});
        })
        .catch(() => {
        ...
        <div className="flex flex-col items-center justify-center h-full relative">
          ...
          {token ? (
            <div className="flex flex-col items-center justify-center">
              <h2 className="text-3xl font-bold text-primary">Set New Password</h2>
              <form onSubmit={handlePasswordReset} className="w-full mt-12 flex flex-col items-center">
                <Input
                  type="password"
                ...
                />
                <Button type="submit" className="w-full h-14 text-base font-semibold mt-8" disabled={isLoading}>
                  Change Password
                </Button>
              </form>
            </div>
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-2xl text-foreground mt-12">Enter registered email address</p>
              <form onSubmit={handleEmailSubmit} className="w-full mt-12 flex flex-col items-center">
                <Input
                  type="email"
                  placeholder="Email"
                  className="bg-[#1E2024] h-14 text-foreground border-none"
            ...
            <div className="flex flex-col items-start justify-center">
              ...
              <p className="text-sm text-foreground mt-4">Check your email for the reset link. If you don't see it, please check your spam folder.</p>
              <Button
                type="button"
